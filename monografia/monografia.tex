...
\begin{teorema}
    Para quaisquer $k,p,q\geq 2$ inteiro existe um inteiro $N=R^k(p,q)$ tal que qualquer coloração dos subconjuntos de tamaho $k$ de $\{1,...,N\}$ possui $p$ subconjuntos de tamanho $k$ azuis ou $q$ subconjuntos de tamanho $k$ vermelhos.
\end{teorema}
\begin{proof}
\end{proof}
