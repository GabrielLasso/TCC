...
\begin{proof}
    ...
    Para $i\in\{2,...,l-1\}$, seja $A_i$ os pontos de $P$ da fronteira de $(P\cap A_{i-1}) \setminus A_{i-1}$ e seja $A_l=(P\cap A_{i-1})\setminus A_{i-1}$.

    Pelo lema \ref{convex} com $k=5$, para cada $i\in\{2,...,l\}$, quaisquer $2l-1$ pontos consecutivos em $A_i$ possuem $5$ pontos em posição estritamente convexa. Para que $P$ não tenha pentágonos vazios, o casco convexo desses $2l-1$ pontos deve conter um ponto de $A_{i-1}$.
    ...
    Suponha que para algum $i\in\{2,...,l\}$ vale $A_i=\emptyset$. Então $|A_{i-1}| < (2l-1)$, $|A_{i-2}| < (2l-1)^2 + (2l-1)$, $|A_{i-3}| < (2l-1)^3 (2l-1)^2 + (2l-1)$, ..., e é fácil mostrar por indução que
